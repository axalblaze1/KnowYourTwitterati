...
def establish_connection():
    global auth
    global api
    auth = tweepy.OAuthHandler("Put key/token", "Put key/token")# can be obtained from twitter 
...
def retweet_perc(tweets_list):
    ...
    if (retweet==0 and ori_tweet==0):
        re_ori_ratio = 0
    else:
        re_ori_ratio= retweet/(retweet+ori_tweet)
...
def complete_user_analysis(screen_name):
    ...
    retweet_perc = user[7]
    retweet_perc = format(100*retweet_perc, '.2f')
    ...
    output = output + str(week0) + "##" + str(week1) + "##" + str(week2) + "##" + str(week3) + "##" + str(week4) + "##" + str(week5) + "##" + str(week6) + "_flag_sep_esc_"
